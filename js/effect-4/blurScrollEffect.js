...
export class BlurScrollEffect {
  ...
  scroll() {
    ...
    gsap.fromTo(words, {
      ...
      gsap.fromTo(this.dividerElement, {
      opacity: 0,
    }, {
      opacity: 1,
      scrollTrigger: {
        trigger: this.dividerElement, // Element that triggers the animation.
        start: 'top bottom-=10%', // Divider becomes visible when it's near the bottom of the viewport.
        end: 'bottom center+=10%', // Animation ends when it reaches the center of the viewport.
        scrub: true, // Animation progress tied to scroll position.
      },
    });
  }
